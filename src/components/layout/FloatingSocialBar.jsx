...
export const FloatingSocialBar = () => {
  ...
  // Hidden while the mobile drawer is open - the same icons appear inside
  // the drawer instead (see MobileNav) - and restored as soon as it closes.
  const isVisible = isRevealed && !isMobileNavOpen;
