      ...
      <ul className="flex items-center">
        ...
        <li ref={servicesRef}>
          <button
            ...
            className="flex items-center gap-0.5 px-3 py-2 text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600"
          >
            Services
            <RiArrowDropDownLine
              aria-hidden="true"
