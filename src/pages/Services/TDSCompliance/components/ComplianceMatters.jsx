...
import { FiShield, FiClock, FiAlertTriangle, FiPieChart } from "react-icons/fi";
...
const benefits = [
  { icon: FiShield, label: "Avoid Interest & Penalties" },
  { icon: FiClock, label: "Timely Form 16/16A Issuance" },
  { icon: FiAlertTriangle, label: "Fewer Mismatch Notices" },
  { icon: FiPieChart, label: "Audit-Ready Records" },
];
        ...
        >
          <div className="overflow-hidden rounded-3xl border border-brand-700/10 shadow-xl">
            <img
              ...
              alt="Finance team reviewing TDS deduction records"
              loading="lazy"
              decoding="async"
