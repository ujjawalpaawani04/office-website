...
const steps = [
  { title: "Business Understanding", description: "We learn where and how TDS applies across your payments." },
  { title: "Document Collection", description: "Gathering payment records, PAN details and applicable rates." },
  { title: "TDS Review", description: "Assessing your current deduction, deposit and filing status." },
  { title: "Deduction & Return Preparation", description: "Preparing accurate deductions and quarterly returns." },
