...
export const HomeHero = () => {
  return (
    <section className="relative max-h-[700px] isolate flex h-[100vh] lg:max-h-[900px] w-full items-center overflow-hidden bg-secondary pb-10 lg:pb-0 pt-28">
      ...
      <Container className="relative grid  gap-10 lg:grid-cols-2 lg:gap-8 h-full ">
        ...
        <motion.div
          ...
          className="relative order-1 mx-auto content-end overflow-hidden lg:block hidden"
        >
