    ...
    <section className="relative isolate flex h-[70vh] max-h-[700px] w-full items-center overflow-hidden bg-secondary pb-16 lg:pb-0 pt-25">
      ...
      <Container className="relative">
        <div className="max-w-3xl">
          ...
          >
            Audit &amp; <span className="text-highlight">Assurance</span>
          </motion.h1>
          ...
          >
            We provide comprehensive Audit &amp; Assurance services, including statutory
            audits, tax audits, and internal audits, helping businesses maintain
            regulatory compliance, improve financial transparency, strengthen internal
            controls, and build stakeholder confidence through accurate and independent
            financial reporting.
          </motion.p>
