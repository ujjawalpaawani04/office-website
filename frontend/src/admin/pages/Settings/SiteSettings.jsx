      ...
      <div className="max-w-xl rounded-xl border border-secondary/10 bg-white p-5">
        {loading || !form ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <TextField id="settings-hours" label="Business Hours" placeholder="e.g. Mon-Sat, 10am-6pm" value={form.businessHours || ""} error={errors.businessHours} onChange={(e) => setField("businessHours", e.target.value)} />
