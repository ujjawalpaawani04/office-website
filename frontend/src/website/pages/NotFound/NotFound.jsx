  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center bg-[#f5f5f5] py-24">
      ...
      <Container className="text-center">
        <h1 className="font-display text-3xl font-bold text-black">Page Not Found</h1>
        <p className="mt-3 text-black/60">The page you're looking for doesn't exist or may have been moved.</p>
        <Link
          to="/"
