...
import { navLinks, useServicesMenu, isServicesMenuItemActive } from "../../constants/navigation";
  ...
  return (
    <div className="lg:hidden">
      ...
      <div
        ...
        aria-hidden="true"
        className={cn(
          "fixed inset-x-0 top-16 bottom-0 z-40 mt-1 bg-black/90 transition-opacity duration-300 ease-out",
